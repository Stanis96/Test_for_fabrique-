    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text_message",
                    models.TextField(verbose_name="Текст сообщения для доставки клиенту"),
                ),
                (
                    "date_of_ending",
                    models.DateTimeField(verbose_name="Дата и время окончания рассылки"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operator_code",
                    models.CharField(max_length=3, verbose_name="Код мобильного оператора"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Дата и время создания отправки"
                    ),
                ),
                (
                    "status_of_send",
                    models.CharField(
                        choices=[("NONE", "none"), ("SUCSESS", "sucsess"), ("FAIL", "fail")],
                        default="NONE",
                        max_length=8,
